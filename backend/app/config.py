...
class Settings(BaseSettings):
    ...
    data_retention_mode: str = "local"
    retention_policy_store_path: str = "data/synthetic/retention_policies.json"
    retention_scan_results_store_path: str = "data/synthetic/retention_scan_results.json"
    legal_hold_store_path: str = "data/synthetic/legal_holds.json"
    compliance_export_store_path: str = "data/synthetic/compliance_exports.json"
    archive_store_path: str = "data/archive"
    purge_dry_run_default: bool = True
    retention_auto_archive_enabled: bool = False
    retention_auto_purge_enabled: bool = False
    retention_require_approval_for_purge: bool = True
    retention_require_approval_for_archive: bool = False
    retention_default_fraud_case_days: int = 2555
    retention_default_audit_event_days: int = 3650
    retention_default_ai_output_days: int = 1095
    retention_default_agent_trace_days: int = 365
    retention_default_telemetry_days: int = 90
    retention_default_notification_days: int = 180
    retention_default_cost_record_days: int = 730
    retention_default_feedback_days: int = 1095
    retention_default_incident_days: int = 2555
    retention_default_config_history_days: int = 2555
    retention_archive_after_percentage: int = 80
    retention_review_lookahead_days: int = 30
    compliance_export_path: str = "data/exports/compliance"
    compliance_export_include_audit: bool = True
    compliance_export_include_ai_outputs: bool = True
