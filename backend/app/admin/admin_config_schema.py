...
SAFE_CONFIG_REGISTRY: dict[str, ConfigDefinition] = {
    ...
    "NOTIFICATION_SYSTEM_ENABLED": _item("NOTIFICATION_SYSTEM_ENABLED", "NOTIFICATIONS", "boolean", True, "Enable notification system."),
    "NOTIFICATION_ENABLE_IN_APP": _item("NOTIFICATION_ENABLE_IN_APP", "NOTIFICATIONS", "boolean", True, "Enable in-app notifications."),
    "NOTIFICATION_ENABLE_LOCAL": _item("NOTIFICATION_ENABLE_LOCAL", "NOTIFICATIONS", "boolean", True, "Enable local delivery records."),
    "NOTIFICATION_ENABLE_EMAIL": _item("NOTIFICATION_ENABLE_EMAIL", "NOTIFICATIONS", "boolean", False, "Enable email channel when configured securely."),
    "NOTIFICATION_ENABLE_TEAMS": _item("NOTIFICATION_ENABLE_TEAMS", "NOTIFICATIONS", "boolean", False, "Enable Teams channel when configured securely."),
    "NOTIFICATION_ENABLE_WEBHOOK": _item("NOTIFICATION_ENABLE_WEBHOOK", "NOTIFICATIONS", "boolean", False, "Enable generic webhook channel when configured securely."),
    "NOTIFICATION_DEFAULT_CHANNELS": _item("NOTIFICATION_DEFAULT_CHANNELS", "NOTIFICATIONS", "string", "IN_APP,LOCAL", "Default notification channels."),
    "NOTIFICATION_MAX_RETRY_COUNT": _item("NOTIFICATION_MAX_RETRY_COUNT", "NOTIFICATIONS", "integer", 3, "Maximum notification retry count.", min_value=0, max_value=20),
    "NOTIFICATION_RETENTION_DAYS": _item("NOTIFICATION_RETENTION_DAYS", "NOTIFICATIONS", "integer", 90, "Notification retention in days.", min_value=1, max_value=3650),
    "FEEDBACK_LOOP_ENABLED": _item("FEEDBACK_LOOP_ENABLED", "AI_FEEDBACK", "boolean", True, "Enable the local AI feedback loop."),
    "FEEDBACK_REQUIRE_COMMENT_FOR_NEGATIVE_RATING": _item("FEEDBACK_REQUIRE_COMMENT_FOR_NEGATIVE_RATING", "AI_FEEDBACK", "boolean", True, "Require comments for poor AI feedback ratings."),
    "FEEDBACK_MIN_COMMENT_LENGTH": _item("FEEDBACK_MIN_COMMENT_LENGTH", "AI_FEEDBACK", "integer", 10, "Minimum comment length for negative AI feedback.", min_value=0, max_value=500),
    "FEEDBACK_AUTO_CREATE_BACKLOG_FOR_CRITICAL": _item("FEEDBACK_AUTO_CREATE_BACKLOG_FOR_CRITICAL", "AI_FEEDBACK", "boolean", True, "Create improvement backlog items for critical feedback."),
    "FEEDBACK_AUTO_NOTIFY_ADMIN_FOR_CRITICAL": _item("FEEDBACK_AUTO_NOTIFY_ADMIN_FOR_CRITICAL", "AI_FEEDBACK", "boolean", True, "Notify admins when critical AI feedback is submitted."),
    "FEEDBACK_AUTO_EXPORT_ACCEPTED_TO_EVAL": _item("FEEDBACK_AUTO_EXPORT_ACCEPTED_TO_EVAL", "AI_FEEDBACK", "boolean", False, "Automatically export accepted feedback to evaluation datasets."),
    "DEPLOYMENT_MODE": _item("DEPLOYMENT_MODE", "SECURITY_DEPLOYMENT", "string", "local", "Deployment mode label.", editable=False),
    "SECRET_PROVIDER": _item("SECRET_PROVIDER", "SECURITY_DEPLOYMENT", "enum", "environment", "Configured secret provider.", editable=False, allowed=["environment", "key_vault"]),
    "KEY_VAULT_ENABLED": _item("KEY_VAULT_ENABLED", "SECURITY_DEPLOYMENT", "boolean", False, "Whether Key Vault secret loading is enabled.", editable=False),
